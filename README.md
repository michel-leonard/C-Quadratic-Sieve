...
*The quadratic sieve is able to factor number fewer than 120-bit without using a multiplier. It's not set up as it can be an interesting challenge left to the developers. Thank You.*
