...
**Example** : the algorithm can choose the wrong multiplier, this can involve extra calculations, and `param_alloc` must be increased (methodically, in increments of 10%) in the source code if a segmentation error occurs for this reason.
