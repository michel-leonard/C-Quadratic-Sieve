...
static void manager_add_simple_factor(state *state, qs_md num, int pow, int is_prime);
...
static cint * qs_divisors_uniqueness_helper(qs_sheet *qs, const cint *num);
...
// Verbose Level 0: Just need a factorization of N, no other messages.
