...
int read_key_and_2_values(const char **, state *);
int read_key_and_3_values(const char **, state *);
static int read_key_value(char const **, state *);
...
// Verbose level 2: also displays final status and progress of tasks in percentage.
